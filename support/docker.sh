...
git clone https://github.com/Luzzu/Framework.git Luzzu
cd Luzzu
mvn clean install

echo "Setting up Metrics"
cd $PATH_INSTALLATION/Luzzu/luzzu-communications/externals/metrics/
...
cd $PATH_INSTALLATION/Luzzu/luzzu-communications/externals/vocabs/
